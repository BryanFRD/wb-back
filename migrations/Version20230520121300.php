 ...
 */
final class Version20230520121300 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE module ADD status ENUM(\'active\', \'faulty\', \'inactive\') NOT NULL COMMENT \'(DC2Type:status_enum)\'');
    }
